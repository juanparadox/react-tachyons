...
const SocialCircles = ({ icons }) =>
	<footer className="pv4 ph3 ph5-ns tc">
    { icons.map((item, index) => 
      <a className="link dim gray dib h2 w2 br-100 mr3 pa2 bg-near-white ba b--black-10" href={ item.href } title={ item.hrefTitle } key={ index }>
